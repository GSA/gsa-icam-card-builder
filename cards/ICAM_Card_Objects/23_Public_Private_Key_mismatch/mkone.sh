...
#RAF#
#RAF### Card 23
#RAF#T=Public_Private_Key_mismatch
...
#RAF#DEST="../cards/ICAM_Card_Objects/23_$T"
#RAF#cp -p data/ICAM_*_$T.p12 "$DEST"
#RAF#cp -p data/pem/ICAM_*_$T.crt "$DEST"
#RAF#renameIn "$DEST" 1 1
#RAF#
...
sh mkcert.sh -w -b -s "ICAM_Test_Card_PIV_Auth_SP_800-73-4_$T" -i ICAM_Test_Card_PIV_Signing_CA_-_gold_gen1-2 -n 23 -t piv-dig-sig || exit $?
sh mkcert.sh -w -b -s "ICAM_Test_Card_PIV_Card_Auth_SP_800-73-4_$T" -i ICAM_Test_Card_PIV_Signing_CA_-_gold_gen1-2 -n 23 -t piv-key-mgmt || exit $?
