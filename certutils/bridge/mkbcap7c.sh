...
ls [0-3]*.crt ../roots/00_ICAM_Test_Card_Root_CA.crt ICAM_Test_Card_Bridge_CA.crt | awk 'BEGIN { printf ("openssl crl2pkcs7 -nocrl -outform der -out ../aia/certsIssuedToICAMTestCardBridgeCA.p7c ") } { printf("-certfile %s ", $1) }' >>/tmp/t.$$.sh
echo >>/tmp/t.$$.sh
