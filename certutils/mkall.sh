...
sh mkcert.sh -w -b -s ICAM_PIV_Card_Auth_SP_800-73-4_PPS -i ICAM_Test_Card_PIV_Signing_CA_-_gold_gen3 -n 37 -t piv-card-auth -e secp384r1
...
cp -p data/ICAM_PIV*SP_800-73-4_Bad_SO_Hash.p12 "$DEST"
cp -p data/pem/ICAM_PIV*SP_800-73-4_Bad_SO_Hash.crt "$DEST"
renameIn "$DEST" 1 1
...
cp -p data/ICAM_Fed_PIV-I*SP_800-73-4.p12 "$DEST"
cp -p data/pem/ICAM_Fed_PIV-I*SP_800-73-4.crt "$DEST"
renameIn "$DEST" 1 1
...
cp -p data/ICAM_PIV_*SP_800-73-4_Re-key.p12 "$DEST"
cp -p data/pem/ICAM_PIV_*SP_800-73-4_Re-key.crt "$DEST"
renameIn "$DEST" 1 1
...
cp -p data/ICAM_PIV_*SP_800-73-4_OCSP_Expired.p12 "$DEST"
cp -p data/pem/ICAM_PIV_*SP_800-73-4_OCSP_Expired.crt "$DEST"
renameIn "$DEST" 1 1
...
cp -p data/ICAM_PIV_*SP_800-73-4_OCSP_Revoked_NOCHECK.p12 "$DEST"
cp -p data/pem/ICAM_PIV_*SP_800-73-4_OCSP_Revoked_NOCHECK.crt "$DEST"
renameIn "$DEST" 1 1
...
cp -p data/ICAM_PIV_*SP_800-73-4_OCSP_Revoked_WO_NOCHECK.p12 "$DEST"
cp -p data/pem/ICAM_PIV_*SP_800-73-4_OCSP_Revoked_WO_NOCHECK.crt "$DEST"
renameIn "$DEST" 1 1
...
cp -p data/ICAM_PIV_*SP_800-73-4_OCSP_Invalid_Signature.p12 "$DEST"
cp -p data/pem/ICAM_PIV_*SP_800-73-4_OCSP_Invalid_Signature.crt "$DEST"
renameIn "$DEST" 1 1
...
cp -p data/ICAM_PIV_*SP_800-73-4.p12 "$DEST"
cp -p data/pem/ICAM_PIV_*SP_800-73-4.crt "$DEST"
renameIn "$DEST" 1 0
...
cp -p data/ICAM_PIV_*SP_800-73-4_SAN_Order.p12 "$DEST"
cp -p data/pem/ICAM_PIV_*SP_800-73-4_SAN_Order.crt "$DEST"
renameIn "$DEST" 1 1
...
cp -p data/ICAM_PIV_*SP_800-73-4_FI_Expired.p12 "$DEST"
cp -p data/pem/ICAM_PIV_*SP_800-73-4_FI_Expired.crt "$DEST"
renameIn "$DEST" 1 1
...
cp -p data/ICAM_PIV_*SP_800-73-4_FI_will_Expire.p12 "$DEST"
cp -p data/pem/ICAM_PIV_*SP_800-73-4_FI_will_Expire.crt "$DEST"
renameIn "$DEST" 1 1
...
cp -p data/ICAM_PIV_*SP_800-73-4_FP_Expired.p12 "$DEST"
cp -p data/pem/ICAM_PIV_*SP_800-73-4_FP_Expired.crt "$DEST"
renameIn "$DEST" 1 1
...
cp -p data/ICAM_PIV_*SP_800-73-4_FP_will_Expire.p12 "$DEST"
cp -p data/pem/ICAM_PIV_*SP_800-73-4_FP_will_Expire.crt "$DEST"
renameIn "$DEST" 1 1
...
cp -p data/ICAM_PIV_*SP_800-73-4_Large_Cert.p12 "$DEST"
cp -p data/pem/ICAM_PIV_*SP_800-73-4_Large_Cert.crt "$DEST"
renameIn "$DEST" 1 1
...
cp -p data/ICAM_NFI_PIV-I*SP_800-73-4.p12 "$DEST"
cp -p data/pem/ICAM_NFI_PIV-I*SP_800-73-4.crt "$DEST"
renameIn "$DEST" 1 1
