...
for any of the four certificates on a PIV or PIV-I card. `mkcert.sh` is usually invoked
...
```
cd certutils/data/database
vi piv-rsa-2048-index.txt
```

Note the columns of a CA index (*-index.txt) file:
...
V^I201202000000Z^I^I600000000000000000CB^Iunknown^I$
