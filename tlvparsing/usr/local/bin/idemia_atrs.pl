...
cont:
  ...
  my %appconfs = (
    0x00 => "CIV Configuration FIPS 140-2 Level 2",
    0x01 => "SPE and SPE-EP Configurations FIPS 140-2 level 3",
    0x02 => "TWIC Configuration FIPS 140-2 Level 2",
    0x04 => "NPIVP Configuration FIPS 140-2 Level 2 Validated",
    0x0B => "NPIVP Configuration FIPS 140-2 Level 2 Validated",
    0x10 => "NPIVP Configuration FIPS 140-2 Level 2 Validated"
  );
